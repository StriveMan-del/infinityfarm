...
class PHPMailer
{
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        if ($this->DKIM_copyHeaderFields && count($copiedHeaders) > 0) {
            ...
            foreach ($copiedHeaders as $copiedHeader) {
                ...
                if (strlen($copiedHeader) > self::STD_LINE_LENGTH - 3) {
                    $copiedHeaderFields .= substr(chunk_split($copiedHeader, self::STD_LINE_LENGTH - 3, static::$LE . ' '), 0, -strlen(static::$LE . ' '));
                } else {
        ...
        $dkimSignatureHeader = 'DKIM-Signature: v=1;' . ' d=' . $this->DKIM_domain . ';' . ' s=' . $this->DKIM_selector . ';' . static::$LE . ' a=' . $DKIMsignatureType . ';' . ' q=' . $DKIMquery . ';' . ' l=' . $DKIMlen . ';' . ' t=' . $DKIMtime . ';' . ' c=' . $DKIMcanonicalization . ';' . static::$LE . $headerKeys . $ident . $copiedHeaderFields . ' bh=' . $DKIMb64 . ';' . static::$LE . ' b=';
